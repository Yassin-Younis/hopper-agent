...
export const tools: ChatCompletionTool[] = [{
    ...
    type: "function", function: {
        name: "fill", description: "Fills an input field with a given value.", parameters: {
            type: "object", properties: {
                id: {
                    type: "string", description: "The field's unique identifier. A Simple number in string format, DONT include brackets or anything else."
                }, value: {
    ...
    type: "function", function: {
        "name": "select_option", "description": "Selects an option from a dropdown.", "parameters": {
            "type": "object", "properties": {
                "id": {
                    "type": "string", "description": "The dropdown's unique identifier. A Simple number in string format, DONT include brackets or anything else."
                }, "opts": {
    ...
    type: "function", function: {
        name: "click", description: "Simulates a mouse click on an element.", parameters: {
            type: "object", properties: {
                id: {type: "string", description: "The element's unique identifier. A Simple number in string format, DONT include brackets or anything else."}, button: {
                    type: "string",
    ...
    type: "function", function: {
        name: "hover", description: "Moves the mouse cursor over an element.", parameters: {
            type: "object", properties: {
                id: {type: "string", description: "The element's unique identifier. A Simple number in string format, DONT include brackets or anything else."}
            }, required: ["id"]
        }
    }
}, {
    ...
    type: "function", function: {
        name: "drag_and_drop", description: "Drags an element and drops it onto another.", parameters: {
            type: "object", properties: {
                from_id: {type: "string", description: "The element to drag. A Simple number in string format, DONT include brackets or anything else."},
                to_id: {type: "string", description: "The target drop location. A Simple number in string format, DONT include brackets or anything else."}
    ...
    //             type: "object",
    //             properties: {
    //                 id: {type: "string", description: "The file input's unique identifier. A Simple number in string format, DONT include brackets or anything else."},
    //                 file: {
    //                     type: ["string", "array"],
